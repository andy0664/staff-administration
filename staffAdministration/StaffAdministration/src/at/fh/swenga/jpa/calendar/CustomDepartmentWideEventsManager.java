...
public class CustomDepartmentWideEventsManager extends DHXEventsManager {
	
	private User user;
	private String userDepartment;
	private boolean createDepartmentEvent;

	public CustomDepartmentWideEventsManager(HttpServletRequest request) {
		super(request);
		// user = (User)
	...
	public CustomDepartmentWideEventsManager(HttpServletRequest request, boolean createDepartmentEvent, String department) {
		super(request);
		// user = (User)
		// SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		// System.out.println("Username========================"+user.getUsername());
	...
	public DHXEv createEvent(String id, DHXStatus status) {
		...
		for (GrantedAuthority auth : user.getAuthorities()) {
            if (Constant.ROLE_MANAGER.equals(auth.getAuthority()))
